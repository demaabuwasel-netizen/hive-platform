...
export default function HeroParallax({ bgImage, leafImages = {} }) {
  ...
  return (
    ...
    >
      ...
      {/* Hero Title Overlay */}
      <motion.div
        className="absolute inset-0 flex items-start justify-center pointer-events-none pt-52"
      ...
      >
        <div className="text-center max-w-4xl px-6">
          <h1 className="text-6xl md:text-7xl font-bold leading-tight" style={{ color: '#FFFFFF' }}>
            <span style={{ textShadow: '0 4px 24px rgba(0,0,0,0.3), 0 2px 8px rgba(0,0,0,0.2)' }}>
              Connect talent<br />
              with
            </span>
            <br />
